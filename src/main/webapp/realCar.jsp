...
String sql = "select *from cars where username='" + username + "'";
...
<div class="middle">
		...
		<tr>
			...
			<tr>
				...
				<td class="tddel"><a href="dodelCar.jsp?vid=<%=rs.getString("vid")%>"><b class="del">移出购物车</b></a></td>
			</tr>
